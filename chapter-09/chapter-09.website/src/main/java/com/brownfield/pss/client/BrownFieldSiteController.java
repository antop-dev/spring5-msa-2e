...
public class BrownFieldSiteController {
    ...
    public String greetingSubmit(@ModelAttribute UIData uiData, Model model) {
        Flight[] flights = searchClient.postForObject("http://172.17.0.1:8090/search/get", uiData.getSearchQuery(), Flight[].class);
    ...
    public String ConfirmBooking(@ModelAttribute UIData uiData, Model model) {
        ...
        long bookingId = 0;
        try {
            bookingId = bookingClient.postForObject("http://172.17.0.1:8060/booking/create", booking, long.class);
    ...
    public String searchBookingSubmit(@ModelAttribute UIData uiData, Model model) {
        ...
        BookingRecord booking = bookingClient.getForObject("http://172.17.0.1:8060/booking/get/" + id, BookingRecord.class);
    ...
    public String bookQuery(@PathVariable String flightNumber,
        ...
        long checkinId = checkInClient.postForObject("http://172.17.0.1:8070/checkin/create", checkIn, long.class);
